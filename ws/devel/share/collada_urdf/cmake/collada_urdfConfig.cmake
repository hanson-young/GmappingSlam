...
if("TRUE" STREQUAL "TRUE")
  set(collada_urdf_SOURCE_PREFIX /home/flysnow/ws/src/collada_urdf)
  set(collada_urdf_DEVEL_PREFIX /home/flysnow/ws/devel)
  ...
  set(collada_urdf_INSTALL_PREFIX /home/flysnow/ws/install)
...
if(NOT "/home/flysnow/ws/src/collada_urdf/include " STREQUAL " ")
  set(collada_urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/flysnow/ws/src/collada_urdf/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/flysnow/ws/src/collada_urdf/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
    endif()
