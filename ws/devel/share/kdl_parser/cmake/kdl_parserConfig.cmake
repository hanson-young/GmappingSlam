...
if("TRUE" STREQUAL "TRUE")
  set(kdl_parser_SOURCE_PREFIX /home/flysnow/ws/src/kdl_parser)
  set(kdl_parser_DEVEL_PREFIX /home/flysnow/ws/devel)
  ...
  set(kdl_parser_INSTALL_PREFIX /home/flysnow/ws/install)
...
if(NOT "/home/flysnow/ws/src/kdl_parser/include;/usr/include/eigen3;/opt/ros/indigo/include;/usr/include " STREQUAL " ")
  set(kdl_parser_INCLUDE_DIRS "")
  set(_include_dirs "/home/flysnow/ws/src/kdl_parser/include;/usr/include/eigen3;/opt/ros/indigo/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kdl_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/flysnow/ws/src/kdl_parser/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
    endif()
    _list_append_unique(kdl_parser_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "kdl_parser;/opt/ros/indigo/lib/liborocos-kdl.so;/opt/ros/indigo/lib/liborocos-kdl.so.1.3.0;/usr/lib/x86_64-linux-gnu/libtinyxml.so")
