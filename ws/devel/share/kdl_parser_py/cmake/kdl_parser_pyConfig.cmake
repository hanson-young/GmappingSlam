...
if("TRUE" STREQUAL "TRUE")
  set(kdl_parser_py_SOURCE_PREFIX /home/flysnow/ws/src/kdl_parser_py)
  set(kdl_parser_py_DEVEL_PREFIX /home/flysnow/ws/devel)
  ...
  set(kdl_parser_py_INSTALL_PREFIX /home/flysnow/ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kdl_parser_py' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jackie Kay <jackie@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kdl_parser_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/flysnow/ws/src/kdl_parser_py/${idir}'.  Ask the maintainer 'Jackie Kay <jackie@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${kdl_parser_py_dep}_FOUND)
      find_package(${kdl_parser_py_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${kdl_parser_py_dep} REQUIRED ${depend_list})
  endif()
